...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net pr_4bits_tri_i_1 [get_bd_ports pr_4bits_tri_i] [get_bd_pins xlslice_0/Din]
  ...
  connect_bd_net -net xlconstant_0_dout [get_bd_pins xlconcat_0/In0] [get_bd_pins xlconcat_0/In2] [get_bd_pins xlconcat_0/In3] [get_bd_pins xlconcat_1/In1] [get_bd_pins xlconstant_0/dout]
  connect_bd_net -net xlconstant_1_dout [get_bd_pins xlconcat_1/In0] [get_bd_pins xlconcat_1/In2] [get_bd_pins xlconcat_1/In3] [get_bd_pins xlconstant_1/dout]
