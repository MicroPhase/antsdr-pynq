...
if { $list_projs eq "" } {
   create_project prio_linux prio_linux -part xczu7ev-ffvc1156-2-e
...
proc create_hier_cell_pr_3 { parentCell nameHier } {
  ...
  create_bd_intf_pin -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 pr_4bits
  ...
  connect_bd_intf_net -intf_net Conn2 [get_bd_intf_pins pr_4bits] [get_bd_intf_pins axi_gpio_0/GPIO]
...
proc create_root_design { parentCell } {
  ...
  set pr_4bits_0 [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 pr_4bits_0 ]
  set pr_4bits_1 [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 pr_4bits_1 ]
  set pr_4bits_2 [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 pr_4bits_2 ]
  set pr_4bits_3 [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 pr_4bits_3 ]
  ...
  set_property -dict [ list \
   CONFIG.ALL_PARAMS {HAS_AXI_LITE 0 HAS_AXIS_CONTROL 0 HAS_SIGNAL_STATUS 0 INTF {intf_0 {ID 0 VLNV xilinx.com:interface:aximm_rtl:1.0 PROTOCOL axi4lite SIGNALS {ARVALID {PRESENT 1 WIDTH 1} ARREADY {PRESENT 1 WIDTH 1} AWVALID {PRESENT 1 WIDTH 1} AWREADY {PRESENT 1 WIDTH 1} BVALID {PRESENT 1 WIDTH 1} BREADY {PRESENT 1 WIDTH 1} RVALID {PRESENT 1 WIDTH 1} RREADY {PRESENT 1 WIDTH 1} WVALID {PRESENT 1 WIDTH 1} WREADY {PRESENT 1 WIDTH 1} AWADDR {PRESENT 1 WIDTH 40} AWLEN {PRESENT 0 WIDTH 8} AWSIZE {PRESENT 0 WIDTH 3} AWBURST {PRESENT 0 WIDTH 2} AWLOCK {PRESENT 0 WIDTH 1} AWCACHE {PRESENT 0 WIDTH 4} AWPROT {PRESENT 1 WIDTH 3} WDATA {PRESENT 1 WIDTH 32} WSTRB {PRESENT 1 WIDTH 4} WLAST {PRESENT 0 WIDTH 1} BRESP {PRESENT 1 WIDTH 2} ARADDR {PRESENT 1 WIDTH 40} ARLEN {PRESENT 0 WIDTH 8} ARSIZE {PRESENT 0 WIDTH 3} ARBURST {PRESENT 0 WIDTH 2} ARLOCK {PRESENT 0 WIDTH 1} ARCACHE {PRESENT 0 WIDTH 4} ARPROT {PRESENT 1 WIDTH 3} RDATA {PRESENT 1 WIDTH 32} RRESP {PRESENT 1 WIDTH 2} RLAST {PRESENT 0 WIDTH 1} AWID {PRESENT 0 WIDTH 0} AWREGION {PRESENT 1 WIDTH 4} AWQOS {PRESENT 1 WIDTH 4} AWUSER {PRESENT 0 WIDTH 0} WID {PRESENT 0 WIDTH 0} WUSER {PRESENT 0 WIDTH 0} BID {PRESENT 0 WIDTH 0} BUSER {PRESENT 0 WIDTH 0} ARID {PRESENT 0 WIDTH 0} ARREGION {PRESENT 1 WIDTH 4} ARQOS {PRESENT 1 WIDTH 4} ARUSER {PRESENT 0 WIDTH 0} RID {PRESENT 0 WIDTH 0} RUSER {PRESENT 0 WIDTH 0}}}} IPI_PROP_COUNT 8} \
   CONFIG.GUI_HAS_AXIS_CONTROL {0} \
   CONFIG.GUI_HAS_AXI_LITE {0} \
   CONFIG.GUI_HAS_SIGNAL_STATUS {false} \
   CONFIG.GUI_INTERFACE_NAME {intf_0} \
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net axi_interconnect_M00_AXI [get_bd_intf_pins axi_interconnect/M00_AXI] [get_bd_intf_pins pr_decoupler_3/rp_intf_0]
  ...
  connect_bd_net -net net_zynq_us_ss_0_clk_out2 [get_bd_pins proc_sys_reset_1/slowest_sync_clk] [get_bd_pins ps_e_0/pl_clk1]
  connect_bd_net -net net_zynq_us_ss_0_peripheral_aresetn [get_bd_pins axi_interconnect/M00_ARESETN] [get_bd_pins axi_interconnect/M01_ARESETN] [get_bd_pins axi_interconnect/M02_ARESETN] [get_bd_pins axi_interconnect/M03_ARESETN] [get_bd_pins axi_interconnect/M04_ARESETN] [get_bd_pins axi_interconnect/S00_ARESETN] [get_bd_pins pr_0/s_axi_aresetn] [get_bd_pins pr_1/s_axi_aresetn] [get_bd_pins pr_2/s_axi_aresetn] [get_bd_pins pr_3/s_axi_aresetn] [get_bd_pins proc_sys_reset_0/peripheral_aresetn] [get_bd_pins reset_control/s_axi_aresetn]
  connect_bd_net -net net_zynq_us_ss_0_s_axi_aclk [get_bd_pins axi_interconnect/ACLK] [get_bd_pins axi_interconnect/M00_ACLK] [get_bd_pins axi_interconnect/M01_ACLK] [get_bd_pins axi_interconnect/M02_ACLK] [get_bd_pins axi_interconnect/M03_ACLK] [get_bd_pins axi_interconnect/M04_ACLK] [get_bd_pins axi_interconnect/S00_ACLK] [get_bd_pins pr_0/s_axi_aclk] [get_bd_pins pr_1/s_axi_aclk] [get_bd_pins pr_2/s_axi_aclk] [get_bd_pins pr_3/s_axi_aclk] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins ps_e_0/maxihpm0_lpd_aclk] [get_bd_pins ps_e_0/pl_clk0] [get_bd_pins reset_control/s_axi_aclk]
  connect_bd_net -net pr_0_ip2intc_irpt [get_bd_pins pr_0/ip2intc_irpt] [get_bd_pins xlconcat_0/In1]
  connect_bd_net -net pr_1_ip2intc_irpt [get_bd_pins pr_1/ip2intc_irpt] [get_bd_pins xlconcat_0/In2]
  connect_bd_net -net pr_2_ip2intc_irpt [get_bd_pins pr_2/ip2intc_irpt] [get_bd_pins xlconcat_0/In3]
  connect_bd_net -net pr_3_ip2intc_irpt [get_bd_pins pr_3/ip2intc_irpt] [get_bd_pins xlconcat_0/In4]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x80100000 [get_bd_addr_spaces ps_e_0/Data] [get_bd_addr_segs pr_0/axi_gpio_0/S_AXI/Reg] SEG_axi_gpio_0_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x80130000 [get_bd_addr_spaces ps_e_0/Data] [get_bd_addr_segs pr_3/axi_gpio_0/S_AXI/Reg] SEG_axi_gpio_0_Reg1
  create_bd_addr_seg -range 0x00010000 -offset 0x80110000 [get_bd_addr_spaces ps_e_0/Data] [get_bd_addr_segs pr_1/axi_gpio_0/S_AXI/Reg] SEG_axi_gpio_0_Reg2
  create_bd_addr_seg -range 0x00010000 -offset 0x80120000 [get_bd_addr_spaces ps_e_0/Data] [get_bd_addr_segs pr_2/axi_gpio_0/S_AXI/Reg] SEG_axi_gpio_0_Reg4
  create_bd_addr_seg -range 0x00001000 -offset 0x80044000 [get_bd_addr_spaces ps_e_0/Data] [get_bd_addr_segs reset_control/S_AXI/Reg] SEG_reset_control_Reg
