...
static const struct of_device_id ulite_of_match[] = {
	{ .compatible = "byu,opb-uartlite-1.00.b", },
	{ .compatible = "byu,xps-uartlite-1.00.a", },
	{ .compatible = "byu,axi-uartlite-1.02.a", },
	{}
};
...
static int __init ulite_init(void)
{
	...
	pr_debug("byu_uartlite: calling uart_register_driver()\n");
