...
################################################################
# This is a generated script based on design: led_pattern
#
...
proc create_root_design { parentCell } {
  ...
  set pr_4bits [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 pr_4bits ]
  ...
  connect_bd_intf_net -intf_net Conn1 [get_bd_intf_ports S_AXI] [get_bd_intf_pins axi_gpio_0/S_AXI]
  connect_bd_intf_net -intf_net Conn2 [get_bd_intf_ports pr_4bits] [get_bd_intf_pins axi_gpio_0/GPIO]
