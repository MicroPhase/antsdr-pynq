...
if { $list_projs eq "" } {
   create_project prio prio -part xczu7ev-ffvc1156-2-e
...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net net_zynq_us_ss_0_peripheral_aresetn [get_bd_pins axi_intc_0/s_axi_aresetn] [get_bd_pins axi_interconnect/M00_ARESETN] [get_bd_pins axi_interconnect/M01_ARESETN] [get_bd_pins axi_interconnect/M02_ARESETN] [get_bd_pins axi_interconnect/M03_ARESETN] [get_bd_pins axi_interconnect/M04_ARESETN] [get_bd_pins axi_interconnect/M05_ARESETN] [get_bd_pins axi_interconnect/S00_ARESETN] [get_bd_pins pr_0/s_axi_aresetn] [get_bd_pins pr_1/s_axi_aresetn] [get_bd_pins pr_2/s_axi_aresetn] [get_bd_pins pr_3/s_axi_aresetn] [get_bd_pins proc_sys_reset_0/peripheral_aresetn] [get_bd_pins reset_control/s_axi_aresetn]
  connect_bd_net -net net_zynq_us_ss_0_s_axi_aclk [get_bd_pins axi_intc_0/s_axi_aclk] [get_bd_pins axi_interconnect/ACLK] [get_bd_pins axi_interconnect/M00_ACLK] [get_bd_pins axi_interconnect/M01_ACLK] [get_bd_pins axi_interconnect/M02_ACLK] [get_bd_pins axi_interconnect/M03_ACLK] [get_bd_pins axi_interconnect/M04_ACLK] [get_bd_pins axi_interconnect/M05_ACLK] [get_bd_pins axi_interconnect/S00_ACLK] [get_bd_pins pr_0/s_axi_aclk] [get_bd_pins pr_1/s_axi_aclk] [get_bd_pins pr_2/s_axi_aclk] [get_bd_pins pr_3/s_axi_aclk] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins ps_e_0/maxihpm0_lpd_aclk] [get_bd_pins ps_e_0/pl_clk0] [get_bd_pins reset_control/s_axi_aclk]
  connect_bd_net -net pr0_ip2intc_irpt [get_bd_pins pr_0/ip2intc_irpt] [get_bd_pins xlconcat0/In0]
  ...
  create_bd_addr_seg -range 0x00001000 -offset 0x800E0000 [get_bd_addr_spaces ps_e_0/Data] [get_bd_addr_segs pr_0/axi_gpio_0/S_AXI/Reg] SEG_axi_gpio_0_Reg
  create_bd_addr_seg -range 0x00001000 -offset 0x800E1000 [get_bd_addr_spaces ps_e_0/Data] [get_bd_addr_segs pr_1/axi_gpio_0/S_AXI/Reg] SEG_axi_gpio_0_Reg2
  create_bd_addr_seg -range 0x00001000 -offset 0x800E2000 [get_bd_addr_spaces ps_e_0/Data] [get_bd_addr_segs pr_2/axi_gpio_0/S_AXI/Reg] SEG_axi_gpio_0_Reg4
  create_bd_addr_seg -range 0x00001000 -offset 0x800E3000 [get_bd_addr_spaces ps_e_0/Data] [get_bd_addr_segs pr_3/axi_gpio_0/S_AXI/Reg] SEG_axi_gpio_0_Reg6
  create_bd_addr_seg -range 0x00001000 -offset 0x800E5000 [get_bd_addr_spaces ps_e_0/Data] [get_bd_addr_segs axi_intc_0/S_AXI/Reg] SEG_axi_intc_0_Reg
  create_bd_addr_seg -range 0x00001000 -offset 0x800E4000 [get_bd_addr_spaces ps_e_0/Data] [get_bd_addr_segs reset_control/S_AXI/Reg] SEG_reset_control_Reg
